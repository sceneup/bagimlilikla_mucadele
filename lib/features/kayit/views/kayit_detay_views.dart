          ...
          child: Padding(
            ...
            child:  Container(
              ...
              child: Column(
                spacing: 16,
                children: [
                  KayitBaslik(adim: "2", value: 1, title: "Bize Kendinizden Bahsedin", description: "Bu bilgiler, deneyiminizi kişiselleştirmeye ve değerlendirme sonuçlarınızı iyileştirmeye yardımcı olur. Verileriniz özenle işlenir."),
                  KayitDetayForm(),
                  KayitOlButton(),
                  const Text("© 2026 Sirius. Privacy-focused & secure.")
                ],
              ),
            ),
          ),
